...
public class FourProblem extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fourproblem);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
	    if (keyCode == KeyEvent.KEYCODE_BACK) {
	        PlayGame parentActivity;
	        parentActivity = (PlayGame) this.getParent();
	...
	{
		//		Intent intent = new Intent(FourProblem.this, .class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.four_problem, menu);
		return true;
	}
